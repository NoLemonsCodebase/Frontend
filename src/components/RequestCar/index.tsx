  ...
  return  (
        <div className="bg-[#FEFCE8] py-3 px-4 text-center">
            <div className="flex items-center justify-center">
                ...
                <Link
                className="ml-4 inline-flex items-center rounded-md px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-gray-900/90 focus:outline-none focus:ring-2 focus:ring-gray-950 focus:ring-offset-2 dark:bg-green-700 dark:text-white dark:hover:bg-green-700 dark:focus:ring-gray-300"
                href="/request-a-car"
                >
                Request it
                </Link>
