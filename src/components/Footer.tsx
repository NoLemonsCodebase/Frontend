...
const Footer: React.FunctionComponent<IFooterProps> = (props) => {
  return (
    <footer className="bg-black mb-20 md:mb-0">
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-2 gap-8 ml-4 px-4 py-6 lg:py-8 md:grid-cols-2">
            <div>
      ...
      <div className="pl-6 sm:flex sm:items-center sm:justify-between">
          <span className="lg:pb-20 text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://nolemons.co/" className="hover:underline">NoLemons™</a>. All Rights Reserved.
          </span>
          <div className="flex pb-20 mb-4 mt-4 sm:justify-center sm:mt-0">
        ...
        {/* <div className="px-4 py-6 bg-gray-700 md:flex md:items-center md:justify-between">
            <span className="text-sm text-gray-300 sm:text-center">© 2024 <a href="https://nolemons.co/">NoLemons™</a>. All Rights Reserved.
            </span>
