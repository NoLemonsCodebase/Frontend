          ...
          <div className="grid grid-cols-2 gap-8 ml-4 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
                ...
                <ul className="text-gray-400 font-medium">
                    ...
                    <li className="mb-4">
                        <a href="https://www.nolemons.co/en/p/buyer-guide-local" className="hover:underline">UAE bayer guide</a>
                    </li>
                    <li className="mb-4">
                        <a href="https://www.nolemons.co/en/p/buyer-guide" className="hover:underline">International bayer guide</a>
                    </li>
                    <li className="mb-4">
