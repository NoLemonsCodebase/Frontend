...
const Footer: React.FunctionComponent<IFooterProps> = (props) => {
  return (
    ...
    // <footer classNameName="bg-black  text-white p-10 text-center border-t-2 border-gray-200">
    //   <h1 classNameName="text-3xl font-semibold mb-4">NoLemons</h1>
    //   <p classNameName="mb-4">&copy; 2024 NoLemons</p>
    ...
    //       </svg>
    //     </a>
    //     <a href="https://t.me/nolemons" target="_blank" aria-label="Send">
    //       <svg
    //         role="presentation"
    //         width="30px"
    //         height="30px"
